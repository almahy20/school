...
export function AdminDashboard() {
  ...
  return (
    <div className="flex flex-col gap-6 md:gap-8 lg:gap-10 max-w-[1400px] xl:max-w-[1500px] mx-auto text-right">
      <header className="bg-slate-900 p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl text-white shadow-2xl relative overflow-hidden group">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-8">
          <div className="flex items-center gap-3 md:gap-5 text-right">
            ...
            <div className="space-y-1 md:space-y-1.5">
               <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold tracking-tight leading-tight">مرحباً، {userName}</h1>
          ...
          <div className="flex items-center gap-2 md:gap-3 lg:gap-4 px-4 md:px-6 py-3 md:py-4 rounded-xl md:rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl relative z-10 group hover:scale-105 transition-all w-full md:w-auto">
             ...
             <div className="min-w-0">
               <p className="text-[8px] sm:text-[9px] md:text-[10px] font-bold text-white/40 uppercase tracking-wider leading-none mb-0.5 md:mb-1 text-right">تاريخ اليوم</p>
               <p className="text-xs sm:text-sm md:text-base lg:text-lg font-bold text-white leading-none text-right truncate">
