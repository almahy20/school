    ...
    <div className="fixed bottom-24 left-4 right-4 md:left-auto md:right-8 md:bottom-8 md:w-96 bg-white p-5 rounded-[32px] shadow-2xl border border-indigo-100 z-[9999] animate-in slide-in-from-bottom-5 duration-500" dir="rtl">
      <div className="flex items-start gap-4">
         ...
         <div className="flex-1 space-y-3">
            <div>
               <h3 className="font-black text-slate-900 leading-tight">تطبيق {branding.name}</h3>
               <p className="text-xs font-bold text-slate-500 mt-1 leading-relaxed">قم بتثبيت التطبيق على جهازك للحصول على تجربة أسرع وأكثر استقراراً.</p>
            </div>
