       ...
       <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
             <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100">
                ...
                <p className="text-sm font-black text-slate-900">{Number(fee?.amount_due || 0).toLocaleString()} <span className="text-[9px] opacity-40">ر.س</span></p>
             </div>
             <div className="p-4 rounded-2xl bg-indigo-50/30 border border-indigo-100/50">
                ...
                <p className="text-sm font-black text-indigo-600">{Number(fee?.amount_paid || 0).toLocaleString()} <span className="text-[9px] opacity-40">ر.س</span></p>
             </div>
          </div>
