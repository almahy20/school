...
export default function AdminConversationsPage() {
  ...
  return (
    <AppLayout>
      <div className="max-w-[900px] mx-auto animate-in fade-in duration-500 pb-20 px-4 md:px-0" dir="rtl">
        ...
        {/* Tab content */}
        {tab === 'conversations' ? <ConversationsTab /> : <BroadcastTab />}
      </div>
    </AppLayout>
  );
}
