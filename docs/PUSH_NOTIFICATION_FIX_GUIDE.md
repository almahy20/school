...
### الخطوة 5: متطلبات iOS (iPhone/iPad)
⚠️ **مهم جداً:** الإشعارات على نظام iOS لا تعمل في المتصفح العادي (Safari/Chrome).
1. يجب على المستخدم **تثبيت التطبيق** (Add to Home Screen).
2. يجب فتح التطبيق من الأيقونة الموجودة على الشاشة الرئيسية.
3. عندها فقط سيظهر طلب تفعيل الإشعارات.

---

## د) أنواع الإشعارات المدعومة تلقائياً

| النوع | الحدث المشغل | المستلم |
|-------|--------------|---------|
| 📝 درجات | إضافة/تعديل درجة طالب | ولي الأمر |
| 📅 حضور | غياب أو تأخر طالب | ولي الأمر |
| 💬 رسائل | وصول رسالة جديدة | المستلم |
| 💸 مصروفات | إصدار رسوم شهرية جديدة | ولي الأمر |
| ⚠️ شكاوى | رد الإدارة على شكوى | ولي الأمر |

---

## هـ) أمثلة للاستدعاء من Frontend (PWA)
