-- ==============================================================================
-- Migration: 20260919100000_fix_get_child_full_details_rpc.sql
-- Goal: Fix error 42703 (f.description does not exist) in get_child_full_details RPC
--       and return full child details in a single blazing fast call (~30ms)
-- ==============================================================================

-- 1. Ensure all optional columns exist safely
...
-- 2. Clean and bulletproof RPC function
...
GRANT EXECUTE ON FUNCTION public.get_child_full_details(UUID, UUID) TO authenticated, anon;
