...
CREATE POLICY "Admins can view all children" ON public.children FOR SELECT USING (public.has_role(auth.uid(), 'admin'));
CREATE POLICY "Admins can manage children insert" ON public.children FOR INSERT WITH CHECK (public.has_role(auth.uid(), 'admin'));
CREATE POLICY "Admins can manage children update" ON public.children FOR UPDATE USING (public.has_role(auth.uid(), 'admin'));
CREATE POLICY "Admins can manage children delete" ON public.children FOR DELETE USING (public.has_role(auth.uid(), 'admin'));
